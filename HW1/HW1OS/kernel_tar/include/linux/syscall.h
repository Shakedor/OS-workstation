...
/************************ HW1 ************************/
extern asmlinkage int sys_block_program(const char *name, unsigned int name_len);
extern asmlinkage int sys_unblock_program(const char *name, unsigned int name_len);
extern asmlinkage int sys_is_program_blocked(const char *name, unsigned int name_len);
extern asmlinkage int sys_get_blocked_count(void);
extern asmlinkage int sys_get_forbidden_tries(int pid,char log[][256],unsigned int n);
/************************ HW1 ************************/
